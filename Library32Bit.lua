  ...
  local _base_0 = {
    ...
    apply_settings = function(self, tab)
      ...
      config_group:new_button({
        text = "Save",
        callback = function()
          local config_name = "SpectrumSolV4/" .. tostring(getgenv().window.flags["config_name"]) .. ".json"
          if (not isfolder("SpectrumSolV4")) then
            makefolder("SpectrumSolV4")
          end
          local fixed_config = { }
